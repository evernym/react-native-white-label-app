...
export const ON_COMPUTER = 'On a computer'
export const GO_TO_FABER = ', go to www.evernym.com/faber'
export const USE_TUTORIAL = 'and use this app to go through the tutorial.'

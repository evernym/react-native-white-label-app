...
declare module ramda {
  ...
  declare type Includes = ((string, string) => boolean) &
  ...
  declare function complement<
    ...
    I,
    J,
    Fn: (A, B, C, D, E, F, G, H, I, J) => boolean
  >(
    f: Fn
  ): Fn
  ...
  declare function propSatisfies<T, K>(
    cond: (x: $ElementType<T, K>) => boolean
  ): ((prop: K) => (o: T) => boolean) & ((prop: K, o: T) => boolean)
